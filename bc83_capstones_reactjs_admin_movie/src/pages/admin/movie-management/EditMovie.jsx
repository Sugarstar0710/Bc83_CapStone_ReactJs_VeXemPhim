...
import { X, Upload, Star, Calendar, Edit, Film } from "lucide-react";

const EditMovie = ({ isOpen, onClose, movieData, onUpdate }) => {
  ...
  useEffect(() => {
    if (movieData) {
      const formattedDate = movieData.ngayKhoiChieu
        ? movieData.ngayKhoiChieu.split("T")[0]
        : "";
      ...
      setFormData({
        ...
        danhGia: movieData.danhGia || 5,
        hot: movieData.hot || false,
        dangChieu: movieData.dangChieu || false,
        sapChieu: movieData.sapChieu || false,
        maNhom: movieData.maNhom || "GP00",
      });

      setImagePreview(movieData.hinhAnh || "");
    }
  }, [movieData]);
  ...
  const validateForm = () => {
    ...
    if (!formData.trailer.trim()) {
      ...
      newErrors.trailer = "URL trailer không hợp lệ";
    }
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.hinhAnh && typeof formData.hinhAnh !== "string") {
      updateData.hinhAnh = formData.hinhAnh;
    }
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">ID: {formData.maPhim}</p>
                </div>
              </div>
              <button
                onClick={onClose}
          ...
          <div className="p-6 max-h-[80vh] overflow-y-auto">
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-800/50 border border-gray-600 rounded-lg text-white file:mr-4 file:py-2 file:px-4 file:rounded file:border-0 file:bg-blue-600 file:text-white hover:file:bg-blue-700 transition-all"
                    />
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-6 border-t border-gray-700/50">
                ...
                <button
                  type="submit"
                  className="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-lg transition-all transform hover:scale-105 shadow-lg"
                >
                  Cập Nhật
                </button>
              </div>
